        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WhoPlayed = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Epcomp", x => x.EpisodeCompanionId);
                    table.ForeignKey(
                        name: "FK_Epcomp_Companions_CompanionId",
                        column: x => x.CompanionId,
                        principalTable: "Companions",
                        principalColumn: "CompanionId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Epcomp_Episodes_EpisodeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EpEnemy", x => x.EpisodeEnemyId);
                    table.ForeignKey(
                        name: "FK_EpEnemy_Enemys_EnemyId",
                        column: x => x.EnemyId,
                        principalTable: "Enemys",
                        principalColumn: "EnemyId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EpEnemy_Episodes_EpisodeId",
                        column: x => x.EpisodeId,
                        principalTable: "Episodes",
                        principalColumn: "EpisodeId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Epcomp_CompanionId",
                table: "Epcomp",
                column: "CompanionId");

            migrationBuilder.CreateIndex(
                name: "IX_Epcomp_EpisodeId",
                table: "Epcomp",
                column: "EpisodeId");

            migrationBuilder.CreateIndex(
                name: "IX_EpEnemy_EnemyId",
                table: "EpEnemy",
                column: "EnemyId");

            migrationBuilder.CreateIndex(
                name: "IX_EpEnemy_EpisodeId",
                table: "EpEnemy",
                column: "EpisodeId");
